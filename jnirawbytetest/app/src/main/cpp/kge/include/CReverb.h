...
/************************************************************************/
/* reverberation				                                        */
/* written by ethanzhao,  6-18,2014                                     */
/* last modified by ethanzhao, 8-18,2015                                */
/************************************************************************/
...
class LIB_KALAAUDIOBASE_API Creverb:public IKalaReverb
{
public:
	...
	/* return the real output size. */
	int  Process(char* inChannel, int inSize, char* outBuffer, int outSize);
