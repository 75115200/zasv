/*************************************************************************
  ...
  > Author:        UnKown
  > Mail:          UnKown
  > Created Time:  2013/6/16 12:47:17
 ************************************************************************/
#include <stdlib.h>
#include <string.h>
#include "aes.h"
...
static unsigned char in[16], out[32], state[4][4];
...
int main()
{
	char *str= encrypt("abcdefgvdfesoopb", "123456");

	printf("encrypt result:%s\n", str);

	char *str2 = decrypt(str, "123456");
